...
with a number, contains space) will be detected and a pop-up window pop-out with respective reason to prevent input when adding new ingredient name in 
ingredients_management and food_list, or when in editing ingredient column name.<br />
