...
The working principle of this system after login was showed in below graph (suggested to download and open the /photo/principle.png below showed alone for magnified view):<br />
